        ...
        {status === 'success' ? (
          ...
          <form onSubmit={subscribe} className="mt-3 flex gap-2">
            ...
            <button
              ...
              className="flex items-center justify-center rounded-lg bg-primary px-3 py-2 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-50"
            >
  ...
  return (
    <div className="card rounded-2xl p-8 sm:p-10">
      <div className="mx-auto max-w-xl text-center">
        ...
        <h2 className="mt-4 font-serif text-2xl font-bold tracking-tight">Never miss a story</h2>
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={subscribe} className="mx-auto mt-5 flex max-w-md flex-col gap-3 sm:flex-row">
            ...
            >
              {status === 'loading' ? <Loader2 className="h-4 w-4 animate-spin" /> : <>Subscribe <ArrowRight className="h-4 w-4" /></>}
            </button>
          </form>
        )}
