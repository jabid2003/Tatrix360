...
const SUB_NAV_ITEMS = [
  { label: 'News', href: '/mobile?tab=news' },
  { label: 'Top', href: '/mobile?tab=top' },
  { label: 'Reviews', href: '/mobile?tab=reviews' },
  { label: 'Opinions', href: '/mobile?tab=opinions' },
];
...
interface MobilePageClientProps {
  initialPosts: { type: string; posts: Post[] }[];
}

export function MobilePageClient({ initialPosts }: MobilePageClientProps) {
