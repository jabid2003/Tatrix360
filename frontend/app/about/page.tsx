...
export default function AboutPage() {
  return (
    <main className="container-page max-w-3xl py-10 sm:py-16">
      <header>
        <p className="section-label text-primary">About Tatrix360</p>
      ...
      <section aria-labelledby="values-heading" className="mt-10">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
          {values.map(({ icon: Icon, title, text }) => (
            <article key={title} className="card p-5 transition-colors hover:bg-muted/50">
      ...
      <section className="prose-article mt-12">
        ...
        <p className="text-lg leading-8 text-muted-foreground">
          ...
          reviews you can trust. And practical how-to guides that respect your time.
        </p>
